...
if(isset($_POST['title'])) {
    $title = $_POST['title'];
    $filename = preg_replace("/[^a-z0-9]/i", "_", $title) . ".php"; // create a sanitized filename
    ...
    file_put_contents($filename, $template); // save the page

    echo "Page created! <a href='$filename'>View it here</a>";
}
?>
