...
<head>
    ...
    <title>Admin Create Form Page</title>
</head>

<body>
    <div class="homepage">
        <h1>Create Submission Form
        <div class="logo">
        ...
        <form action="">
            <table id="inputTable">
                <tr>
                    ...
                    <td><textarea id="remarks" rows="4" cols="30"></textarea></td> -->
                </tr>
            </table>
...
<script>
    function addRow() {
        ...
        // cell7.innerHTML = `<td><label for="approval">Approval</label></td>`;
        // cell8.innerHTML = `<td><select name="approval" id="approval">
        //                         <option value="none">Select</option>
        //                         <option value="approved">Approved</option>
        //                         <option value="rejected">Rejected</option>
        //                     </select></td>`;

        // cell9.innerHTML = `<td><label for="remarks">Remarks</label></td>`;
        // cell10.innerHTML = `<td><textarea id="remarks" rows="4" cols="30"></textarea></td>`;
